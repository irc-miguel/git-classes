						...
						<div id="enquete_pesquisa">
							<form id="frm_enquete" method="post">
								...
								<div id="dv_enq_titulo">														
									<input class="cl_enq_titulo" type="text" maxlength="100" name="titulo" id="titulo" value="{$titulo_enq}" />																
								</div>
								<div>
									<label class="cl_enq_descricao"><font size="4" color="#32639A">Descrição: </font></label>
								</div>
								<div id="dv_enq_descricao">
									<textarea class="cl_enq_descricao" name="descricao" id="descricao" rows="5" cols="5">{$descricao_enq}</textarea>																
								</div>
