<?php /* Smarty version 2.6.24, created on 2013-11-09 00:59:27
         compiled from admin/admin_cadastro_pergunta.tpl */ ?>
...
"><?php echo $this->_tpl_vars['tipo']->tipo; ?>
								...
								<input type="hidden" name="id_enquete" value="<?php echo $this->_tpl_vars['enquete']->id; ?>
">		
							</form>
						</div>
