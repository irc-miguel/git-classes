<?php /* Smarty version 2.6.24, created on 2013-11-09 21:49:02
         compiled from admin/admin_editar_resposta.tpl */ ?>
...
"><?php echo $this->_tpl_vars['pergunta']->pergunta; ?>
						...
						<div id="resposta_pesquisa">
							<form id="frm_resposta" method="post">								
								...
								<div>														
									<input class="cl_enq_resposta" type="text" maxlength="150" name="resposta" id="resposta" value="<?php echo $this->_tpl_vars['resposta']->resposta; ?>
" />
								</div>								
...
">
								...
								<input type="hidden" name="id_resposta" value="<?php echo $this->_tpl_vars['resposta']->id; ?>
" >
								<input type="hidden" name="resposta_titulo" value="<?php echo $this->_tpl_vars['resposta']->resposta; ?>
" >
								<input type="hidden" name="id_pergunta" value="<?php echo $this->_tpl_vars['pergunta']->id; ?>
" >		
							</form>
