<?php /* Smarty version 2.6.24, created on 2013-11-09 00:59:29
         compiled from admin/edicao_dados_admin.tpl */ ?>
  ...
  $(document).ready(function(){
	  ...
	  $("#frm_edicao").validate({
		  ...
		  submitHandler: function( form ){
				...
				$.ajax({
					type: "POST",
					url: "/admin/admin_controller/atualizarDados",
					data: dados,
			...
			<div id="page-bgbtm">
				<div id="content">
					...
					<div class="post">
						...
						<div id="edicao" >
							<form id="frm_edicao" method="post">
								<div id="dv_nome">
									<label class="lb_edicao_nome"><font size="4" color="#32639A">Nome: </font></label>								
									<input class="cl_edicao_nome" type="text" maxlength="100" name="nome" id="nome" value="<?php echo $this->_tpl_vars['admin']->nome; ?>
" />																
								</div>
								<div id="dv_email">
									<label class="lb_edicao_email"><font size="4" color="#32639A">Email: </font></label>								
									<input class="cl_edicao_email" type="text" maxlength="100" name="email" id="email" value="<?php echo $this->_tpl_vars['admin']->email_usuario; ?>
" />
								</div>
								<div id="dv_estado">
...
" <?php if ($this->_tpl_vars['estado_admin']->id == $this->_tpl_vars['estado']->id): ?>selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['estado']->nome; ?>
</option>
...
" <?php if ($this->_tpl_vars['admin']->cod_cidade == $this->_tpl_vars['cidade']->id): ?>selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['cidade']->nome; ?>
</option>
										<?php endforeach; endif; unset($_from); ?>
									</select>
								</div>								
								<div id="dv_cep">
									...
									<input class="cl_edicao_cep" type="text" maxlength="20" name="cep" id="cep" value="<?php echo $this->_tpl_vars['admin']->cep; ?>
" />
								</div>								
								<div id="dv_sexo">
									...
									<select class="cl_edicao_sexo" name="sexo" id="sexo" >
										<option value="">Selecione</option>
										<option value="Feminino" <?php if ($this->_tpl_vars['admin']->sexo == 'Feminino'): ?>selected="selected"<?php endif; ?>>Feminino</option>
										<option value="Masculino" <?php if ($this->_tpl_vars['admin']->sexo == 'Masculino'): ?>selected="selected"<?php endif; ?>>Masculino</option>
									</select>
								</div>
								<div id="dv_nasc">
									<label class="lb_edicao_dtnasc"><font size="4" color="#32639A">Data nascimento: </font></label>
									<input class="cl_edicao_dtnasc" type="text" maxlength="20" name="data_nasc" id="data_nasc" value="<?php echo $this->_tpl_vars['admin']->data_nascimento; ?>
" />
								</div>
...
" <?php if ($this->_tpl_vars['admin']->escolaridade == $this->_tpl_vars['escolaridade']->id): ?>selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['escolaridade']->nivel; ?>
</option>
										<?php endforeach; endif; unset($_from); ?>
									</select>
								</div>
								<div id="dv_senha">
									...
									<input class="cl_edicao_senha" type="password" maxlength="20" name="senha" id="senha" value="<?php echo $this->_tpl_vars['admin']->senha; ?>
" />
								</div>
								<div id="dv_confSenha">
									<label class="lb_edicao_confsenha"><font size="4" color="#32639A">Confirme a Senha: </font></label>
									<input class="cl_edicao_confsenha" type="password" maxlength="20" name="conf_senha" id="conf_senha" value="<?php echo $this->_tpl_vars['admin']->senha; ?>
" />
								</div>
								<input type="hidden" name="hdn_id_admin" value="<?php echo $this->_tpl_vars['admin_id']; ?>
" />
