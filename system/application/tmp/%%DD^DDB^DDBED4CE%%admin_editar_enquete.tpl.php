<?php /* Smarty version 2.6.24, created on 2013-11-10 12:40:06
         compiled from admin/admin_editar_enquete.tpl */ ?>
						...
						<div id="enquete_pesquisa">		
							<form id="frm_enquete" method="post">						
								...
								<div id="dv_enq_titulo">														
									<input class="cl_enq_titulo" type="text" maxlength="100" name="titulo" id="titulo" value="<?php echo $this->_tpl_vars['enquete']->titulo; ?>
" />																
								</div>
								<div>
								...
								<div id="dv_enq_descricao">
									<textarea class="cl_enq_descricao" name="descricao" id="descricao" rows="5" cols="5"><?php echo $this->_tpl_vars['enquete']->descricao; ?>
</textarea>																
								</div>
								...
								<input type="hidden" name="enquete_id" value="<?php echo $this->_tpl_vars['enquete']->id; ?>
" >
								<input type="hidden" name="enquete_titulo" value="<?php echo $this->_tpl_vars['enquete']->titulo; ?>
" >
							</form>
						</div>
